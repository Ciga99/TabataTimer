...
export const PresetsContext = createContext<PresetsContextType | undefined>(undefined);

// Generatore di ID unici
const generateId = (): string => `preset_${Date.now()}_${Math.random().toString(36).substr(2, 9)}`;
